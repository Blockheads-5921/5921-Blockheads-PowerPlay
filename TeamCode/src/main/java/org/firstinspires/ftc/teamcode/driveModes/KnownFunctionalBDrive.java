...
public class KnownFunctionalBDrive extends LinearOpMode {
    ...
    private void UpdatePlayer2() {
        ...
        // Currently using manual lifter for Player2, debug Lifter(), then uncomment
        // Lifter() below.
    ...
    private void DriveTrainBase(double drivePower) {
        ...
        // robot.lift.setPower((directionL) * 0.05); // give lift some constant power to
        // prevent fast drops
        // }
        // else if (gamepad2.right_stick_y > -0.5) {
        // robot.lift.setPower((directionL) * 0.01); // give lift some constant power to
        // prevent fast drops
        // }
    }
    ...
    // uncomment start
    // rebuild all of Lifter function, currently just using manual mode above, in
    // drivetrain
    private void Lifter() {
