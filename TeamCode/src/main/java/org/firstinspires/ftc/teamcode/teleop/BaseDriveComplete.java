...
public class BaseDriveComplete extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        */
        while (opModeIsActive()) {
            ...
            DriveTrainBase(drivePower); // see the below method - we're just telling the robot to move at a certain speed
            DriveMicroAdjust(); // just if we need to adjust the robot a tiny bit
        }
    }
    ...
    */
    ...
    /* kind of not very useful, this is pretty self explanatory */
