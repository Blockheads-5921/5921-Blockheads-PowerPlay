...
public class BaseDriveComplete extends LinearOpMode {
    ...
    private void DriveTrainBase(double drivePower) {
        ...
        // or over-retract
            ...
            robot.lift.setPower((liftPower - 0.001) * 1);
        } // the *1 is there to adjust lift speed
    ...
    private void UpdateGripper() {
        ...
        else if (gamepad2.right_trigger > 0.01) serv0.setPower(-0.16 * gamepad2.right_trigger + 0);
    }
